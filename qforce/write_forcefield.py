def write_itp(ff, itp_file, urey):
    """
    Scope:
    ------
    ...
    """
    form_atypes = "{:>5} {:>8.4f} {:>8.4f} {:>4} {:>12.5e} {:>12.5e}\n"
    form_atoms = "{:>5}{:>5}{:>6}{:>8}{:>6}{:>5}{:>11.5f}{:>10.5f}\n"
    form_bonds = "{:>6}{:>6}{:>6}{:>10.5f}{:>13.1f}\n"
    form_angles = "{:>6}{:>6}{:>6}{:>6}{:>10.4f}{:>13.3f}\n"
    ...
    with open(itp_file, "w") as itp:
        ...
        if ff.atom_types != []:
            itp.write("[ atomtypes ]\n")
            itp.write(";name     mass   charge type       sigma     epsilon\n")
        ...
        itp.write(f"{ff.mol_type:>20}         3\n")
        
        #atoms
        itp.write("\n[ atoms ]\n")
        itp.write(";  nr type resnr residue  atom cgrp    charge       mass\n")
        ...
        if ff.thole != []:
            itp.write("\n[ thole_polarization ]\n")
            itp.write(";     ai     aj  func     a     alpha(i)    alpha(j)\n")
        for tho in ff.thole:
