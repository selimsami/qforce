class elements():
    def __init__(self):
        self.sym = ("*", "H", "He", "Li", "Be", "B", "C", "N", "O", "F", "Ne",
                    "Na", "Mg", "Al", "Si", "P", "S", "Cl", "Ar", "K", "Ca",
                    "Sc", "Ti", "V", "Cr", "Mn", "Fe", "Co", "Ni", "Cu", "Zn",
                    "Ga", "Ge", "As", "Se", "Br", "Kr", "Rb", "Sr", "Y", "Zr",
                    "Nb", "Mo", "Tc", "Ru", "Rh", "Pd", "Ag", "Cd", "In")
        self.cov = (0.00, 0.31, 0.28, 1.28, 0.96, 0.84, 0.76, 0.71, 0.66, 0.57,
        ...
        self.maxb = (0, 1, 0, 1, 2, 4, 4, 4, 2, 1, 0, 1, 2, 6, 6, 6, 6, 1, 0,
                     ...
                     6, 6, 6, 6, 6)
        self.mass = (0, 1.00794, 4.002602, 6.941, 9.012182, 10.811, 12.0107,
                     ...
                     294)
        self.eneg = (0.00, 2.20, 0.00, 0.98, 1.57, 2.04, 2.55, 3.04, 3.44,
