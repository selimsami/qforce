...
class Molecule(object):
    ...
    def __init__(self, config, job, qm_out, ext_q=None, ext_lj=None, fit_flexible=False):
        self.name = job.name
        ...
        self.terms = Terms.from_topology(config.terms, self.topo, self.non_bonded, fit_flexible=fit_flexible)
